...
def proccess_raw(raw_dir = 'Data/raw'):
    """
    Args: 
        - raw_dir: Directory of unproccessed data that has genre folder containing songs in wav files
    Returns:
        - song_paths: Return the path of each song
        - labels: Return the label of each song
    """
    song_paths = []
    labels = []
...
def stratified_split(train_ratio = 0.8, val_ratio = 0.1, save_dir = 'Data/splits'):
    """
    Args:
        - train_ratio
        - val_ratio
        - save_dir: Directory to save split csv_files with song_path and label
    """
...
if __name__ == "__main__":
    # Create the csv of the splitted files
    stratified_split()
